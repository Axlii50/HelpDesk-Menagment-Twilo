...
namespace HelpDesk_Menagment_Twilo.Controllers.HelpDesk
{
    ...
    public class HelpDeskController : Controller
    {
        ...
        public IActionResult Index(string AccountID)
        {
            ...
            {
                var Tickets = _context.Ticket.Include(tick => tick.Comments).Include(tick => tick.Account).Where(tick => tick.Status != TicketStatus.Completed && tick.Category == type).ToList();
