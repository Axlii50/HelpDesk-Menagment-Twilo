    ...
    public class AccountsController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Account != null ? 
                          ...
                          Problem("Entity set 'HelpDesk_Menagment_TwiloContext.Account'  is null.");
        }
        ...
        public async Task<IActionResult> Create([Bind("AccountID,Login,Password")] Account account)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(string id, [Bind("AccountID,Login,Password")] Account account)
        {
        ...
        public async Task<IActionResult> DeleteConfirmed(string id)
        {
            ...
            {
                return Problem("Entity set 'HelpDesk_Menagment_TwiloContext.Account'  is null.");
            }
            var account = await _context.Account.FindAsync(id);
            if (account != null)
            {
